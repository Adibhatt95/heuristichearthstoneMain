...
namespace heuristichearthstone.Meta
{
    public class Decks
    {
        /// <summary>
        ...
        public static List<Card> WarlockBasic => new List<Card>()
        {
        ...
        public static List<Card> WarlockStarter => new List<Card>()
        {
            Cards.FromName("Chillwind Yeti"),
            Cards.FromName("Chillwind Yeti"),
        ...
        public static List<Card> EnemyDeck1ForMsHoover => new List<Card>()
        {
            Cards.FromName("Chillwind Yeti"),
            Cards.FromName("Chillwind Yeti"),
            Cards.FromName("Darkscale Healer"),
        ...
        public static List<Card> OurDeck1ForMsHoover => new List<Card>()
        {
            Cards.FromName("Chillwind Yeti"),
            Cards.FromName("Chillwind Yeti"),
            Cards.FromName("Darkscale Healer"),
        ...
        public static List<Card> PaladinBasic => new List<Card>()
        {
        ...
        public static List<Card> HunterBasic => new List<Card>()
        {
